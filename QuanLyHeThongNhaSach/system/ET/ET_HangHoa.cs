...
namespace ET
{
    public class ET_HangHoa
    {
        ...
        public ET_HangHoa(string maHH, string tenHH, string loaiHH, string donviTinh, string nhaPP, string moTa, string ghiChu, string tinhTrang, string tacGia, int giaHH, int slTon)
        {
            this.maHH = maHH;
            this.tenHH = tenHH;
            this.loaiHH = loaiHH;
